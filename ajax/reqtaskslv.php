...
/* Готовимся к запросам */
	...
	$s_query_task="SELECT task.sCode FROM ha_tasks AS task, ha_theory AS theory WHERE theory.id=task.id_theory AND theory.seq_number=".$codenum." AND task.codetype='".$codetype."' AND task.isSolution=1";
